...
-- Positions {{{3
window_layouts = {
    {"Safari",               nil,     "DELL U2719DC",    hs.geometry.unitrect(0.05, 0, 0.75, 1),   nil,        nil},
    {"Firefox", ".* – Home Assistant$", "DELL U2719DC",  hs.geometry.unitrect(0.8, 0, 0.2, 1),     nil,        nil},
    {"Firefox",              nil,     "DELL U2719DC",    hs.geometry.unitrect(0.05, 0, 0.75, 1),   nil,        nil},
    {"Nightly",              nil,     "DELL U2719DC",    hs.geometry.unitrect(0.05, 0, 0.75, 1),   nil,        nil},
    {"FirefoxNightly",       nil,     "DELL U2719DC",    hs.geometry.unitrect(0.05, 0, 0.75, 1),   nil,        nil},
    {"Firefox Nightly",      nil,     "DELL U2719DC",    hs.geometry.unitrect(0.05, 0, 0.75, 1),   nil,        nil},
    {"iTerm2",           ".*@.*",      "Built.in .*",    hs.geometry.unitrect(0.5, 0, 0.5, 0.55),  nil,        nil},
    {"Home Assistant",       nil,     "DELL U2719DC",    hs.geometry.unitrect(0.8, 0, 0.2, 1),     nil,        nil},
}
...
function apply_singlewindow_layout(layouts)
    ...
    hs.printf("Applying layout to app: '%s' window title: '%s'", app:name(), win:title())
    local frame = nil
